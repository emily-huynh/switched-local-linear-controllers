...
if plotData:
    ...
    roadlist = ['straightFront', 'straightBack', 'loopOne', 'loopTwo']
    [road_leftEdges, road_rightEdges, roadGeometries] = plot_road(ax3, roadlist, f'Vehicle Position and Road Edges', 'k--', 'k-.', True)
    ...
    fig2.legend(handles=[k1, k2, k3, k4, road], loc='lower left', bbox_to_anchor=(0.125, 0.125))
